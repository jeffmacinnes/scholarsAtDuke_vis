...
void setup() {
    ...
    mapBG = loadImage("mapBG.png");
    mapOverlay = loadImage("mapBG_buildings_clean.png");
...
class Collaboration {
    ...
    Collaboration(PVector srcPt_geo, PVector dstPt_geo, int totalCollabs) {
        ...
        //if ((totalCollabs >= 1) && (totalCollabs<5)) {
        //    connColor = color(collabPalette[0], 120);
        //} else if ((totalCollabs >=5) && (totalCollabs<15)) {
        //    connColor = color(collabPalette[1], 120);
        //} else if ((totalCollabs >=15) && (totalCollabs<30)) {
        //    connColor = color(collabPalette[2], 120);
        //} else if ((totalCollabs >=30) && (totalCollabs<45)) {
        //    connColor = color(collabPalette[3], 120);
        //} else if (totalCollabs > 45) {
        //    connColor = color(collabPalette[4], 120);
        //}
